...
class VehicleTest {
    ...
    void testGetRegisterDate() {
        ...
        Vehicle vehicle = new Vehicle("00-00-AA", "Vehicle Brand", "Vehicle Model", "1", 10, 10, 1000, registerDate, "10/12/2012", 100);
    ...
    void testGetAcquisitionDate() {
        ...
        Vehicle vehicle = new Vehicle("00-00-AA", "Vehicle Brand", "Vehicle Model", "1", 10, 10, 1000, "10/12/2003", acquisitionDate, 100);
    ...
    @Test
    void testEquals() {
        Vehicle vehicle1 = new Vehicle("00-00-AA", "Vehicle Brand", "Vehicle Model", "1", 10, 10, 1000, "10/12/2003", "10/12/2012", 100);
        Vehicle vehicle2 = new Vehicle("00-00-AA", "Vehicle Brand", "Vehicle Model", "1", 10, 10, 1000, "10/12/2003", "10/12/2012", 100);
