...
public class GreenSpaceSorting {
    ...
    public static List<GreenSpace> sort(List<GreenSpace> listToSort){
        ...
        try {
            ...
            System.out.println("[Warning] Sorting algorithm not found. Using default algorithm.");
        }
        switch (algorithm){
            case SelectionSort:
    ...
    private static List<GreenSpace> bubbleSort(List<GreenSpace> sortedList){
        ...
        System.out.println("[Log] Green spaces sorted. (Bubble sort algorithm used.)");
        return sortedList;
    }
    ...
    private static List<GreenSpace> selectionSort(List<GreenSpace> sortedList) {
        ...
        System.out.println("[Log] Green spaces sorted. (Selection sort algorithm used.)");
        return sortedList;
    }
