...
public class DEIService implements EmailSender{
    ...
    public void sendEmailToCollaborator(String collaboratorEmail, String subject, String body) {
        ...
        try {
            ...
            writer.write("From: " + ApplicationSession.getInstance().getProperties().getProperty(ApplicationSession.EMAIL_NOREPLY) + "@isep.ipp.pt \n");
